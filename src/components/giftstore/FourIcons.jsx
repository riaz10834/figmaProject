...
function FourIcons() {
  ...
  return (
    <div className="w-[98%]  mx-auto mt-[100px] flex flex-col items-center">
      ...
      >
        {[
          { img: "./gift/ficon (4).png", title: "Anniversary Gift" },
          { img: "./gift/ficon (3).png", title: "Wedding Gift" },
          { img: "./gift/ficon (2).png", title: "Graduation Gift" },
          { img: "./gift/ficon (1).png", title: "Birthday Gift" },
        ].map((col, i) => (
          <li
            key={i}
